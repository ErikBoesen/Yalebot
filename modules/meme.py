...
class Meme(Module, ImageUploader):
    ...
    def __init__(self):
        ...
        self.templates = {
            ...
            "brain": (
                {"position": (20, 146), "wrap": 20, "font_size": self.LARGE_FONT_SIZE, "center": False, "center_vertical": True},
                {"position": (20, 450), "wrap": 20, "font_size": self.LARGE_FONT_SIZE, "center": False, "center_vertical": True},
                {"position": (20, 745), "wrap": 20, "font_size": self.LARGE_FONT_SIZE, "center": False, "center_vertical": True},
                {"position": (20, 1040), "wrap": 20, "font_size": self.LARGE_FONT_SIZE, "center": False, "center_vertical": True},
            ),
        }
